...
export const idoMetrics = pgTable("ido_metrics", {
  ...
  minimumTier: varchar("minimum_tier"),
  minimumTierStatus: varchar("minimum_tier_status", { enum: ["confirmed", "not_confirmed", "might_change"] }).default("not_confirmed"),
  tokenTransferTxId: varchar("token_transfer_tx_id"),
  tokenTransferTxIdStatus: varchar("token_transfer_tx_id_status", { enum: ["confirmed", "not_confirmed", "might_change"] }).default("not_confirmed"),
  tokenContractAddress: varchar("token_contract_address"),
  tokenContractAddressStatus: varchar("token_contract_address_status", { enum: ["confirmed", "not_confirmed", "might_change"] }).default("not_confirmed"),
